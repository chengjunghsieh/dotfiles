...
# mac use old bash version, not support \e, <esc>, so use \033
function print_info() {
  echo -e "\033[1;36m$*\033[m" # cyan
}

function print_notice() {
  echo -e "\033[1;35m$*\033[m" # magenta
}

function print_notice() {
  printf "\033[1;35m$*\033[m" # magenta
}

function print_success() {
  echo -e "\033[1;32m$*\033[m" # green
}

function print_warning() {
  echo -e "\033[1;33m$*\033[m" # yellow
}

function print_error() {
  echo -e "\033[1;31m$*\033[m" # red
}

function print_debug() {
  echo -e "\033[1;34m$*\033[m" # blue
}
